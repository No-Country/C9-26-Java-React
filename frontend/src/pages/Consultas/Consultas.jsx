...
const Consultas = () => {
    return (
        <main className='mt-4 m-auto'>
            <h2 className="text-center">Elige cómo quieres contactarte con nosotros</h2>

            <div className='d-flex gap-3'>
                <section className={styles.consult_container}>
                    <p className="text-center mb-5">Completa el formulario con tus datos y nos pondremos en contacto para asesorarte y
                ...
                <section className={styles.consult_turnos}>
                    <p className='text-center'>¿Querés hacer una entrevista en vivo con nosotros para evacuar todas tus dudas? Elegí día y hora aquí.</p>

                    <div className={styles.consul_turnosBox}>
                    ...
                    <div className='d-flex flex-column align-items-center'>
                        <p className='text-center mt-5'>Encontranos también en las redes</p>
