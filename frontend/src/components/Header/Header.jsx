            ...
            <div className='bg-dark d-flex align-items-center'>
                <Container className='d-flex gap-5 py-2 align-items-center' fluid>
                    <div className='py-2 d-flex'>
                        <Button variant="dark" className='p-1 d-flex justify-content-center align-items-center me-md-2'>
                            ...
                            <>
                                ...
                                <Navbar.Collapse id="responsive-navbar-nav">
                                    <Nav className="ms-auto">
                                        ...
                                        <NavLink to={HOME} className='nav-link text-center text-uppercase text-white'>Inicio</NavLink>
